...
const Title = ({ darkMode, setDarkMode }: {darkMode:boolean, setDarkMode: Function}) => (
  <div>
    <div className="flex justify-between">
      <h1 className="text-red-300 dark:text-red-500 font-bold text-lg p-2 ml-8">FireGram</h1>
    ...
    <h2 className="text-center text-gray-800 dark:text-gray-400 font-bold text-3xl mt-10 mb-4">Your Pictures</h2>
    <h3 className="text-center font-medium text-normal text-gray-600 mx-3">
